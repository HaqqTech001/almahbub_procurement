...
class ApiClient {
  ...
  async getRequestStats() {
    return this.request<any>('/requests/admin/stats/overview');
  }
  ...
  async markNotificationAsRead(notificationId: number) {
    return this.request<any>(`/auth/notifications/${notificationId}/read`, {
      method: 'PUT',
    });
  }
  ...
  async getAnnouncementReplies(announcementId: number) {
